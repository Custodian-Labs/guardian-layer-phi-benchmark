...
\midrule
\tp{Cuba}\arr\tp{Havana} & 9\,$\rightarrow$\,2 & salience\\
\tp{San Fernando}\arr\tp{Francsico Luis} & 8\,$\rightarrow$\,3 & garbled\\
\tp{C\'adiz}\arr\tp{Cadiz} & 8\,$\rightarrow$\,4 & accent stripped\\
\tp{Cecilio Pujaz\'on n\textordmasculine26}\arr\tp{ Pujaz\'on n\textordmasculine26} & 8\,$\rightarrow$\,4 & truncation\\
\tp{ignaciotorne@\dots}\arr\tp{ixxxxxxxxxxx@\dots} & 9\,$\rightarrow$\,2 & \tp{x}-mask\\
\tp{23/07/1948}\arr\tp{2xxxxxxxx} & 11\,$\rightarrow$\,4 & \tp{x}-mask\\
\tp{40}\arr\tp{35} (age) & 9\,$\rightarrow$\,2 & bare number\\
\bottomrule
\end{tabular}
