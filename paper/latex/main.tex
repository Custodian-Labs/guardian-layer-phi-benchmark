...
Benchmark & Presidio & OBI & Qwen-9B & Gemma-31B\\
\midrule
ASQ-PHI & 0.0 & 0.7 & 58.1 & 79.8\\
MEDDOCAN & 0.0 & 0.1 & 22.9 & 52.6\\
MultiCoNER & -- & 0.0 & 25.0 & 12.5\\
PII en & 1.9 & 1.0 & 10.0 & 37.6\\
PII nl & 3.8 & 1.0 & 20.5 & 39.5\\
PII fr & 2.2 & 0.5 & 5.9 & 38.2\\
PII de & 0.0 & 1.0 & 11.8 & 41.7\\
\midrule
Mean & \textbf{1.3} & \textbf{0.6} & 22.0 & 43.1\\
\bottomrule
\end{tabular}
\caption{C1 redaction floor: masked-span recall (\%) after replacing each masked value with \tp{*****}, across detector families. Rule/fine-tuned detectors collapse to $\approx$0; open LLMs partly recover the redaction cue (context-dependent). All floors sit well below the surrogate recall in Table~\ref{tab:c2}. LLM and OBI cells use a 120-document subsample per benchmark; Presidio is the full corpus. Per-detector means are over each detector's scored benchmarks (Presidio: 6---MultiCoNER was not in the Presidio baseline; others: 7).}\label{tab:c1}
\end{table}
...
Benchmark & Presidio & OBI & Qwen-9B & Gemma-31B\\
\midrule
ASQ-PHI & 97.7 & 100.0 & 100.0 & 100.0\\
MEDDOCAN & 79.7 & 64.0 & 79.6 & 96.5\\
MultiCoNER & -- & 100.0 & 87.5 & 100.0\\
PII en & 89.2 & 89.5 & 76.7 & 90.0\\
PII nl & 93.0 & 71.8 & 84.1 & 96.9\\
PII fr & 78.5 & 79.5 & 81.4 & 83.2\\
PII de & 78.1 & 84.8 & 77.9 & 95.1\\
\midrule
Mean & 86.0 & 84.2 & 83.9 & \textbf{94.5}\\
\bottomrule
\end{tabular}
\caption{C2 open-surrogate (Faker) retention: masked-span recall (\%) on the same masked spans, across detector families. Every family stays high (means 84--95\%), so detectability preservation is generic to well-formed substitution rather than tool- or detector-specific. Subsampling and mean denominators as in Table~\ref{tab:c1}.}\label{tab:c2}
\end{table}
