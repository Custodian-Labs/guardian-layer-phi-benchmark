...
\bottomrule
\end{tabular}
\caption{C2 open-surrogate (Faker) retention: masked-span recall (\%), across detector families. Every family stays high (means 84--95\%), so detectability preservation is generic to well-formed substitution, not tool- or detector-specific. Subsampling as in Table~\ref{tab:c1}.}\label{tab:c2}
\end{table}
